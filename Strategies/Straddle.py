...
class Straddle:
    ...
    def iron_butterfly_duration(self, startDate,endDate, expiryDate ):
        ...
        costPrice = 0
        if( strikeprice != 0):
            costPrice = self.iron_butterfly_date_cost( strikeprice, startDate, expiryDate )
        ...
        while expiryDate >= evaluationDate:
            sellPrice = self.iron_butterfly_date_cost( strikeprice, evaluationDate, expiryDate )
    ...
    def iron_butterfly_date_cost(self, strikeprice, currentDate, expiryDate):
        costPrice = 0
        try:
