...
The purpose of this Library is to make simple APIs that can query the data from internet and save it. The API will automatically pull data from the DB if it has been pulled before. <br>
